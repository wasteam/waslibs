...
namespace AppStudio.Samples.Common.W10
{
    /// <summary>
    ...
    sealed partial class App : Application
    {
        ...
        protected override void OnLaunched(LaunchActivatedEventArgs e)
        {
            ...
            if (rootFrame.Content == null)
            {
                ...
                // parameter
                //rootFrame.Navigate(typeof(AppStudio.Samples.Common.MainPage), e.Arguments);
            ...
            NavigationService.NavigatedToPage += ((sender, eventArgs) =>
            {
