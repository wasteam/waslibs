...
{
    public sealed partial class RelativeAndVirtualPage : Page
    {
        public RelativeAndVirtualPage()
        {
        ...
        public static readonly DependencyProperty TextProperty = DependencyProperty.Register("Text", typeof(string), typeof(RelativeAndVirtualPage), new PropertyMetadata(null));
        #endregion
    }
}
