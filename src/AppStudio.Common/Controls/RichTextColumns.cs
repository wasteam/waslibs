...
namespace AppStudio.Common.Controls
{
    ...
    public sealed class RichTextColumns : Panel
    {
        ...
        /// </summary>
        public static readonly DependencyProperty RichTextContentProperty = DependencyProperty.Register(
            "RichTextContent", 
        ...
        /// </summary>
        public static readonly DependencyProperty ColumnTemplateProperty = DependencyProperty.Register(
            "ColumnTemplate", 
            typeof(DataTemplate),
            typeof(RichTextColumns), 
            new PropertyMetadata(null, ResetOverflowLayout));
        ...
        /// RichTextBlock child.
        /// </summary>
        private List<RichTextBlockOverflow> overflowColumns = null;
        ...
        protected override Size MeasureOverride(Size availableSize)
        {
            ...
            // done yet
            if (this.overflowColumns == null)
            {
                Children.Add(this.RichTextContent);
                this.overflowColumns = new List<RichTextBlockOverflow>();
            }
            ...
            while (hasOverflow && maxWidth < availableSize.Width && this.ColumnTemplate != null)
            {
                ...
                if (this.overflowColumns.Count > overflowIndex)
                {
                    overflow = this.overflowColumns[overflowIndex];
                }
                else
                {
                    overflow = (RichTextBlockOverflow)this.ColumnTemplate.LoadContent();
                    this.overflowColumns.Add(overflow);
                    ...
                    {
                        this.overflowColumns[overflowIndex - 1].OverflowContentTarget = overflow;
                    }
                }
            ...
            if (this.overflowColumns.Count > overflowIndex)
            {
                ...
                {
                    this.overflowColumns[overflowIndex - 1].OverflowContentTarget = null;
                }

                while (this.overflowColumns.Count > overflowIndex)
                {
                    this.overflowColumns.RemoveAt(overflowIndex);
