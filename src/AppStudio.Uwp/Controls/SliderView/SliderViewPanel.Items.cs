...
namespace AppStudio.Uwp.Controls
{
    partial class SliderViewPanel
    {
        ...
        public static readonly DependencyProperty IndexProperty = DependencyProperty.Register("Index", typeof(int), typeof(SliderViewPanel), new PropertyMetadata(0, IndexChanged));
        #endregion
        ...
        public static readonly DependencyProperty ItemsSourceProperty = DependencyProperty.Register("ItemsSource", typeof(object), typeof(SliderViewPanel), new PropertyMetadata(null, ItemsSourceChanged));
        #endregion
